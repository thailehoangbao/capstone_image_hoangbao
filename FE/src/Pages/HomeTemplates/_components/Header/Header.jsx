    ...
    <header className="p-4 bg-slate-500 text-white">
      <div className="container flex justify-between h-16 mx-auto">
        ...
        <ul className="items-stretch hidden space-x-3 lg:flex">
          ...
          <li className="flex">
            <a rel="noopener noreferrer" href="#" className="flex items-center px-4 -mb-1 border-b-2 dark:border-transparent">Detail</a>
          </li>
          <li className="flex">
        ...
        {!user ? <div className="items-center flex-shrink-0 hidden lg:flex">
          ...
          <div className="items-center flex-shrink-0 hidden lg:flex relative">
            <img className='cursor-pointer' src="https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_640.png" alt="icon-usedr" style={{ width: "50px", height: "50px", borderRadius: "50%", border: "1px solid #888" }} onClick={() => {
              setDropdown(!dropdown)
            }}/>
            {
              dropdown ? <ul className='rounded-md bg-slate-200 absolute overflow-hidden text-black' style={{width:"120px",height:"120px",border:"1px solid black",top:"70px",right:"0"}}>
              <li className='cursor-pointer p-2 text-center hover:bg-blue-400 transition-all duration-500 ease-linear' onClick={() => {
                navigate('/info');
                setDropdown(!dropdown);
              }}>Thông tin</li>
              <li className='cursor-pointer p-2 text-center hover:bg-blue-400 transition-all duration-500 ease-linear' onClick={() => {
