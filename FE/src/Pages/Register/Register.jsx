            ...
            <div className="w-full max-w-md p-8 space-y-3 rounded-xl bg-slate-900 text-white">
                ...
                <form novalidate="" action="" className="space-y-6">
                    ...
                    <button  type='button' className="block w-full p-3 text-center rounded-sm dark:text-gray-900 dark:bg-violet-400" onClick={() => {
                        const full_name = document.querySelector('#username').value;
                ...
                <p className="text-xs text-center sm:px-6 dark:text-gray-400">Don't have an account?
                    <a rel="noopener noreferrer" href="#" className="underline " onClick={() => {
                        navigate('/login')
                    }}>Sign up</a>
                    <a className='hover:text-yellow-500' href="#" onClick={() => {
                        navigate('/')
                    }}>Go Home</a>
                </p>
            </div>
